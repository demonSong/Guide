...
# train = pd.read_csv('feature_score/train.csv')
# test = pd.read_csv('feature_score/test.csv')
...
# train = pd.read_csv('feature/feature_train_poly.csv')
# test = pd.read_csv('feature/feature_test_poly.csv')
feature_score = pd.read_csv('feature_score/feature_score_poly.csv')

print len(train)
print len(train.columns)

TestResult = pd.read_csv('Result/test3.csv')
print len(test)
...
# print ("TestResult---->score_acu:", round(0.96130 *metrics.roc_auc_score(TestResult_label, y_predict), 5))
#
#
